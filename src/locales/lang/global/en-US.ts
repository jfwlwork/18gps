export default {
  ...
  'app.setting.pagestyle.top': 'Top layout',
  'app.setting.pagestyle.side': 'Side layout',
  'app.setting.pagestyle.mix': 'Mixed layout',
  'app.setting.content-width.contentWidth': 'Content Width',
  'app.setting.content-width.fixed': 'Fixed',
  'app.setting.content-width.fluid': 'Fluid',
  'app.setting.content-width.fixedHeader': 'Fixed Header',
  'app.setting.content-width.fixSiderbar': 'Fixed Sidebar',
  ...
  'app.setting.content-width.leftCollapsed': 'Side menu on the left',
  ...
  'app.setting.copyinfo': 'Copied successfully. Please replace defaults in config/default-setting.js',
  'app.setting.production.hint': 'Settings panel appears only in development. Please modify the config file manually in production',
  ...
  'menu.form.step-form.info': 'Step Form (enter transfer information)',
  ...
  'menu.home.custom': 'Dashboard',
  'menu.company.custom': 'Device Management',
  'menu.myUsers.custom': 'My Customers',
  'menu.mallOrders.custom': 'Store Orders',
  'menu.inOutStatistics.custom': 'Inventory In/Out Statistics',
  'menu.vehicleManagement.custom': 'Risk Control',
  'menu.securityCheck.custom': 'Security Inspection',
  'menu.securityCheck.list.custom': 'Device List',
  'menu.securityCheck.vehicleModel.custom': 'Vehicle Model Management',
  'menu.securityCheck.detail.custom': 'Device Details',
}
