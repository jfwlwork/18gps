...
export default [
  ...
  },
  {
    ...
    component: () => import('~/pages/myUsers/list.vue'),
  },
  {
    path: '/mallOrders',
    name: 'mallOrders',
    ...
    component: () => import('~/pages/mallOrders/403.vue'),
  },
  {
    ...
    component: () => import('~/pages/distributor/index.vue'),
  },
  {
    ...
    component: () => import('~/pages/vehicleManagement/list.vue'),
  },
    ...
    children: [
      {
        ...
        component: () => import('~/pages/securityCheck/list.vue'),
      },
      {
        ...
        component: () => import('~/pages/securityCheck/vehicleModel.vue'),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        component: () => import('~/pages/securityCheck/detail.vue'),
      },
    ],
  },
